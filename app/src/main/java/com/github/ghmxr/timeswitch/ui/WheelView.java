...
//            position = divided + offset + 1;
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            if(isenabled)paint.setColor(Color.parseColor("#83cde6"));else paint.setColor(Color.parseColor("#90a9b2"));
    ...
    private void onSeletedCallBack() {
        if (null != onWheelViewListener) {
            if(selectedIndex<items.size()&&selectedIndex>=0) onWheelViewListener.onSelected(selectedIndex, items.get(selectedIndex));
        }
    ...
    public void setEnabled(boolean isenabled){
        ...
        refreshItemView(getScrollChanged);
        if(paint!=null){
            if(this.isenabled)paint.setColor(Color.parseColor("#83cde6"));else paint.setColor(Color.parseColor("#90a9b2"));
        }
    }
