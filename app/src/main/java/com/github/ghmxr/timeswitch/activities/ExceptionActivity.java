    ...
    private void refreshBatteryTemperatureView(){
        ...
        try{
            if(Integer.parseInt(exceptions[ExceptionConsts.EXCEPTION_BATTERY_LOWER_THAN_TEMPERATURE])>=0){
                value.setText(this.getResources().getString(R.string.dialog_battery_compare_lower_than)+exceptions[ExceptionConsts.EXCEPTION_BATTERY_LOWER_THAN_TEMPERATURE]+"℃");
            }else if(Integer.parseInt(exceptions[ExceptionConsts.EXCEPTION_BATTERY_HIGHER_THAN_TEMPERATURE])>=0){
                value.setText(this.getResources().getString(R.string.dialog_battery_compare_higher_than)+exceptions[ExceptionConsts.EXCEPTION_BATTERY_HIGHER_THAN_TEMPERATURE]+"℃");
            }else {
                value.setText(this.getResources().getString(R.string.dialog_battery_not_enabled));
            }
        }catch (NumberFormatException ne){
